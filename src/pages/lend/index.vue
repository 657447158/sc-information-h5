  ...
  <div class="borrow">
    <div class="borrow-top-wrap">
      <div class="borrow-top">
        <div class="left">
          <div class="left-top">
            <span class="title">发布借出单</span>
            <span>（闲钱借出）</span>
          </div>
          <p class="intro">找不到合适的订单，下个借出单让借款人来找你!</p>
        </div>
        <router-link class="right" to='/public-lend'>发布借出单</router-link>
      </div>
    </div>
    <div class="borrow-total">
      <div class="borrow-total-top">
        <span class="title">我要借出</span>
      ...
      <div class="borrow-total-ct">
        ...
        <ul class="nav-list">
          ...
          <router-link class="nav-list-item" tag="li" to="/my-lend/history">
            <span class="icon icon2"></span>
            <span>历史借出单</span>
          </router-link>
          <router-link class="nav-list-item" tag="li" to="/my-lend/public">
      ...
      <ul class="borrow-list" slot="list">
        ...
        >
          <div class="top">
            ...
            <router-link class="btn" :to="{path: '/lend-order', query: {loanId: item.loanId}}">借出</router-link>
          </div>
    ...
    &-total {
      ...
      &-top {
        ...
        .icon {
          ...
          width: 30px;
          height: 28px;
          background: url('../../assets/images/icon-screening-lend.png') no-repeat center / 100% 100%;
        }
      }
      &-ct {
        padding: 32px 0 38px;
      ...
      .nav-list {
        ...
        .icon {
          ...
          &1 { background-image: url('../../assets/images/lend-icon1.png') }
          &2 { background-image: url('../../assets/images/lend-icon2.png') }
          &3 { background-image: url('../../assets/images/lend-icon3.png') }
        }
      }
    }
    &-list {
      ...
      .top {
        ...
        .btn {
          ...
          font-size: 24px;
          background: #4491F3;
          box-shadow: 0px 1px 6px 0px rgba(68,145,243,0.52);
          border-radius: 20px;
        }
      }
      .time {
